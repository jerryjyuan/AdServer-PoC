    ...
    <div id="tabContent3" class="tabContent" style="display:none">
        <div style="height: 500px">
         ...
         <table height="99%" cellpadding="0">
            ...
            <td style="height: 99%" valign="top">
            
            	
				<iframe id="ifrm_preview" style="width: 99%; height: 450px; border: 1px solid orange; margin-top: 2px; margin-left: 40px">
					Ihr Browser unterstützt leider keine Frames. Bitte verwenden Sie einen Browser, der diese unterstützt.
				</iframe>
		</td>
       </tr>
